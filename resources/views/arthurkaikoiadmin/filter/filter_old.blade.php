                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span style="display: flex !important">
                                                    ...
                                                    <a href="#bannerformmodal{{ $k->id_koi }}"
                                                        ...
                                                        data-target="#modalDelete{{ $k->id_koi }}" style="width: 30px"><i class="far fa-trash-alt"></i></a> |
                                            ...
                                            <td>{{ $k->koi_code }}</td>
                                            <td>@foreach($k->history as $h) {{ $h->year }} @endforeach</td>
                                            <td>{{ $k->nickname }}</td>
                                            ...
                                            <td>@foreach($k->history as $h) @if ($loop->first){{ $h->size }} @else
                                                @endif @endforeach</td>
                                            <td>{{ $k->salleragent }}</td>
                                            <td>@foreach($k->history as $h) @if ($loop->first){{ $h->hagent }} @else
                                                @endif @endforeach</td>
                                            <td>{{ $k->pricebuy_idr }}</td>
                                            <td>{{ $k->pricebuy_jpy }}</td>
                                            <td>{{ $k->kep_loc }}</td>
                                            <td>@foreach($k->history as $h) @if ($loop->first){{ $h->pricesell_idr }}
                                                @else @endif @endforeach</td>
                                            <td>@foreach($k->history as $h) @if ($loop->first){{ $h->pricesell_jpy }}
                                                @else @endif @endforeach</td>
                                            <td>@foreach($k->history as $h) @if ($loop->first){{ $h->date_sell }} @else
                                                @endif @endforeach</td>
                                            <td>@foreach($k->history as $h) @if ($loop->first){{ $h->buyer_name }} @else
                                                @endif @endforeach</td>
                                            <td>@foreach($k->history as $h) @if ($loop->first){{ $h->death_date }} @else
                                                @endif @endforeach</td>
                                            <td>@foreach($k->history as $h) @if ($loop->first){{ $h->death_note }} @else
                                                @endif @endforeach</td>
                                            <td>{{ $k->breeder }}</td>
                                            <td>{{ $k->bloodline }}</td>
                                        </tr>
