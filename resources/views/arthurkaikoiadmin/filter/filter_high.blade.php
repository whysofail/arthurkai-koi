...
<div class="content-wrapper" style="background: white;">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="dataKoi" class="table table-bordered table-striped" style="width: 100% !important;">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th></th>
    ...
    var table = $('#dataKoi').DataTable({
        ...
        responsive: true,
        ajax: {
            url: '{!! route('getDataKoihigh') !!}',
            type: 'GET'
        },
        columns: [
            { data: null, name: 'index', orderable: false, searchable: false },
            { data: 'action', name: 'action', orderable: false, searchable: false },
            { data: 'koi_code', name: 'koi_code' },
            { data: 'history_year', name: 'history_year' },
            { data: 'nickname', name: 'nickname' },
            { data: 'variety', name: 'variety' },
            { data: 'gender', name: 'gender' },
            { data: 'birth', name: 'birth' },
            { data: 'age', name: 'age' },
            { data: 'date_purchese', name: 'date_purchese' },
            { data: 'size', name: 'size' },
            { data: 'salleragent', name: 'salleragent' },
            { data: 'handling_agent', name: 'handling_agent' },
            { data: 'pricebuy_idr', name: 'pricebuy_idr' },
            { data: 'pricebuy_jpy', name: 'pricebuy_jpy' },
            { data: 'kep_loc', name: 'kep_loc' },
            { data: 'sell_price_idr', name: 'sell_price_idr' },
            { data: 'sell_price_jpy', name: 'sell_price_jpy' },
            { data: 'date_of_sell', name: 'date_of_sell' },
            { data: 'buyer_name', name: 'buyer_name' },
            { data: 'date_of_death', name: 'date_of_death' },
            { data: 'death_note', name: 'death_note' },
