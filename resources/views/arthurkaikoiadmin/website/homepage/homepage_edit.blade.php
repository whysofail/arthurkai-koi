...
<div class="content-wrapper" style="background: white;">
    ...
    <section class="content">
        ...
        <form action="{{ route('cmsaboutusUpdate') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="id" value="{{ $a->id_aboutus }}">
            <div class="col-sm-12">
                            ...
                            <section id="section-1" class="content-current">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="input-group">
                                      <img src="{{ asset('img/koi/website/aboutus/' . $a->image) }}" id="imageAbout" class="img-thumbnail" style="width: 200px;">
                                      <div class="custom-file">
                                        <input type="file" name="image" accept="image/*" class="custom-file-input" id="imageInput" onchange="promoImage(event)">
                                        <label class="custom-file-label" for="imageInput" id="imageLabel">{{ old('image') ? old('image') : $a->image }}</label>
