...
<div class="content-wrapper" style="background: white;">
    ...
    <section class="content">
        ...
        <form action="{{ route('cmsourcollectionUpdate') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="id" value="{{ $o->id_ourcollection }}">
            <div class="col-sm-12">
                            ...
                            <section id="section-1" class="content-current">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="input-group">
                                      <img src="{{ asset('img/koi/website/ourcollection/' . $o->image) }}" id="imageAbout" class="img-thumbnail" style="width: 200px;">
                                      <div class="custom-file">
                                        <input type="file" name="image" accept="image/*" class="custom-file-input" id="imageInput" onchange="promoImage(event)">
                                        <label class="custom-file-label" for="imageInput" id="imageLabel">{{ old('image') ? old('image') : $o->image }}</label>
                                ...
                                <div class="col-sm-12" style="margin-top: 20px;">
                                    ...
                                    <textarea id="deskripsi_singkat" name="deskripsi_singkat" class="form-control" rows="7" placeholder="">{{ old('deskripsi_singkat') ? old('deskripsi_singkat') : $o->deskripsi_singkat }}</textarea>
                                </div>

                                <div class="col-sm-12" style="margin-top: 20px;">
                                    <label>Deskripsi</label>
                                    <textarea id="deskripsi" name="deskripsi" rows="7">
                                        {{ old('deskripsi') ? old('deskripsi') : $o->deskripsi }}
                                    </textarea>
                                </div>
