                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span style="display: flex !important">
                                                            ...
                                                            <a href="{{ route("cmsourcollectionEdit", $o->id_ourcollection) }}"
                                                                type="button" class="btn btn-info btn-xs">Edit</a> |

                                                            <a href="{{ route("cmsourcollectionDelete", $o->id_ourcollection) }}"
                                                    ...
                                                    <td>
                                                        ...
                                                        <a
                                                            href="{{ route("cmskoidetail", $o->koi_id) }}">{{ $o->koi_id . " | " . $o->koi->koi_code }}</a>
