            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="row">
                            <div class="col-sm-8">
                                <a href="{{ route('cmsourcollectionAdd') }}">
                                    <button type="button" class="btn btn-success"
                                        style=" background: green; color: white; "><b>+ Add Our Collection</b></button>
                                </a>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span style="display: flex !important">
                                                    <a href="{{ route('cmsourcollectionEdit', $o->id_ourcollection) }}" type="button"
                                                        class="btn btn-info btn-xs">Edit</a> |
                                                    <a href="{{ route('cmsourcollectionDelete', $o->id_ourcollection) }}" type="button"
                                                        class="btn btn-danger btn-xs">Delete</a>
                                                </span>
                                            </td>
                                            <td>
                                            <a href="{{ route('cmskoidetail', $o->koi_id) }}">{{ $o->koi_id . ' | ' . $o->koi->koi_code }}</a>
                                            </td>
                                            <td>{{ $o->title }}</td>
                                            <td>
                                            @if($o->image != null)
