            ...
            <nav class="mt-2">
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item" style="border-bottom: 3px solid #0186fc; display:flex;">
                        ...
                        <a href="{{ route("cmskoigrid") }}" class="nav-link"
                            style="text-align: right; background: black; height: 50px;">
                                    ...
                                    <section id="section-1" class="content-current">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" name="variety"
                                                        value="{{ old("variety") ? old("variety") : $k->variety }}"
                                                        id="variety">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <select class="form-control select2" name="gender"
                                                        ...
                                                        <option value="Male"
                                                            {{ $k->gender == "Male" ? "selected" : "" }}>Male</option>

                                                        <option value="Female"
                                                            {{ $k->gender == "Female" ? "selected" : "" }}>Female</option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" name="bloodline"
                                                        value="{{ old("bloodline") ? old("bloodline") : $k->bloodline }}"
                                                        id="bloodline">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" name="breeder"
                                                        value="{{ old("breeder") ? old("breeder") : $k->breeder }}"
                                                        id="breeder">
                                        ...
                                        <div class="col-sm-12" style="margin-top: 10px">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label for="date_purchese" class="col-sm-2 col-form-label">Date Ownership
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" name="hagent"
                                                        value="{{ old("hagent") ? old("hagent") : $k->hagent }}"
                                                        id="hagent">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" name="salleragent"
                                                        value="{{ old("salleragent") ? old("salleragent") : $k->salleragent }}"
                                                        id="salleragent">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" name="kep_loc"
                                                        value="{{ old("kep_loc") ? old("kep_loc") : $k->kep_loc }}"
                                                        id="kep_loc">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" name="pricesell_idr"
                                                        value="{{ old("pricesell_idr") ? old("pricesell_idr") : $k->pricesell_idr }}"
                                                        id="pricesell_idr">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" name="pricesell_jpy"
                                                        value="{{ old("pricesell_jpy") ? old("pricesell_jpy") : $k->pricesell_jpy }}"
                                                        id="pricesell_jpy">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" name="date_sell"
                                                        value="{{ old("date_sell") ? old("date_sell") : $k->date_sell }}"
                                                        id="date_sell">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="custom-file">
                                                        ...
                                                        <input type="file" name="photo_highlight[]" accept="image/*"
                                                            class="custom-file-input" id="photo_highlight"
                                                            onchange="Imagephotohighlight(event)" multiple>

                                                        <label class="custom-file-label" for="exampleInputFile"></label>

                                                        <input type="hidden" name="photo_highlights"
                                                            value="{{ $k->photo_highlight }}">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="custom-file">
                                                        ...
                                                        <input type="file" name="link_photo[]" accept="image/*"
                                                            class="custom-file-input" id="link_photo"
                                                            onchange="Imagelinkphoto(event)" multiple>
                                        ...
                                        <div class="col-sm-12 mt-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="custom-file">
                                                    ...
                                                    <input type="file" name="link_video[]" accept=" video/*"
                                                        class="custom-file-input" id="link_video"
                                                        onchange="promoImagelinkvideo(event)" multiple>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" class="form-control" name="name_trophy"
                                                        value="{{ old("name_trophy") ? old("name_trophy") : $k->name_trophy }}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" class="form-control" name="name_certificate"
                                                        value="{{ old("name_certificate") ? old("name_certificate") : $k->name_certificate }}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" name="buyer_name"
                                                        value="{{ old("buyer_name") ? old("buyer_name") : $k->buyer_name }}"
                                                        id="buyer_name">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="date" class="form-control" name="death_date"
                                                        value="{{ old("death_date") ? old("death_date") : $k->death_date }}"
                                                        id="death_date">
