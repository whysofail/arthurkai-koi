                            ...
                            <section id="section-1" class="content-current">
                                ...
                                <div class="col-sm-12" style="margin-top: 10px">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control select2" name="variety" style="width: 100%;" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="month" class="form-control" name="birth"
                                                value="{{ old('birth') }}" id="birth" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12" style="margin-top: 10px">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control select2" name="bloodline" style="width: 100%;" required>
                                ...
                                <div class="col-sm-12" style="margin-top: 10px">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control select2" name="breeder" style="width: 100%;" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="month" class="form-control" name="date_purchese"
                                                value="{{ old('date_purchese') }}" id="date_purchese" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12" style="margin-top: 10px">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control select2" name="salleragent" style="width: 100%;" required>
                                                <option selected="selected">Selected Seller Agent</option>
                                                @foreach($agent as $a)
                                                <option value="{{ $a->agent_owner }}">{{ $a->agent_owner }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="pricebuy_idr" class="form-control" name="pricebuy_idr"
                                                value="{{ old('pricebuy_idr') }}" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="pricebuy_jpy" class="form-control" name="pricebuy_jpy"
                                                value="{{ old('pricebuy_jpy') }}" required>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group realprocodePH control-group lst incrementPH">
                                                    <input type="file" name="photo_highlight[]" class="myfrm form-control" onchange="photohighlight(event)" required>
                                        ...
                                        <div class="col-sm-10" id="satu">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group realprocodeLP control-group lst incrementLP">
                                                    <input type="file" name="link_photo[]" class="myfrm form-control" onchange="Imagelinkphoto(event)" required>
                                                    <div class="input-group-btn">
            ...
            success: function(data) {
                if (data.suggestions.length > 0) {
                    ...
                    $.each(data.suggestions, function(index, item) {
                        $('#results').append('<li class="list-group-item list-group-item-action">' + item.name + '</li>');
                    });
                }
            }
        });
