                                ...
                                <div class="content tab" id="contentDataKOI">
                                    ...
                                    <section id="section-1" class="content-current">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <select class="form-control select2" name="variety"
                                                        ...
                                                        <option value="{{ $k->variety }}"
                                                            {{ $k->variety == $k->variety ? "selected" : "" }}>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="month" class="form-control" name="birth"
                                                        value="{{ old("birth") ? old("birth") : $k->birth }}"
                                                        id="birth">
                                        ...
                                        <input type="hidden" name="age"
                                            value="@if ($k->birth) @php $umur = \Carbon\Carbon::parse($k->birth)->diff(\Carbon\Carbon::now()); $umurTahun = $umur->y;$umurBulan = $umur->m; echo $umurTahun . ' tahun ' . $umurBulan . ' bulan';@endphp @else @endif">
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <select class="form-control select2" name="bloodline"
                                                        ...
                                                        <option value="{{ $k->bloodline }}"
                                                            {{ $k->bloodline == $k->bloodline ? "selected" : "" }}>
                                        ...
                                        <div class="col-sm-12" style="margin-top: 10px">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="hidden" name="pricebuy_jpy"
                                                        value="{{ $k->pricebuy_jpy }}">

                                                    <input type="text" class="form-control" name="pricebuy_jpy"
                                                        value="{{ old("pricebuy_jpy") ? old("pricebuy_jpy") : $k->pricebuy_jpy }}"
                                                        id="pricebuy_jpy" disabled>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <select class="form-control select2" name="year" id="year"
                                                        ...
                                                        <option value="2018" {{ $k->year == "2018" ? "selected" : "" }}>

                                                            2018</option>

                                                        <option value="2019" {{ $k->year == "2019" ? "selected" : "" }}>

                                                            2019</option>

                                                        <option value="2020" {{ $k->year == "2020" ? "selected" : "" }}>

                                                            2020</option>

                                                        <option value="2021" {{ $k->year == "2021" ? "selected" : "" }}>

                                                            2021</option>

                                                        <option value="2022" {{ $k->year == "2022" ? "selected" : "" }}>

                                                            2022</option>

                                                        <option value="2023" {{ $k->year == "2023" ? "selected" : "" }}>

                                                            2023</option>

                                                        <option value="2024" {{ $k->year == "2024" ? "selected" : "" }}>

                                                            2024</option>

                                                        <option value="2025" {{ $k->year == "2025" ? "selected" : "" }}>

                                                            2025</option>

                                                        <option value="2026" {{ $k->year == "2026" ? "selected" : "" }}>

                                                            2026</option>

                                                        <option value="2027" {{ $k->year == "2027" ? "selected" : "" }}>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" name="size"
                                                        value="@foreach ($k->history as $history)@if ($loop->first){{ old("size") ? old("size") : $history->size }}@else @endif @endforeach"
                                                        id="size">
                                        ...
                                        <div class="col-sm-12" style="margin-top: 10px">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label for="hagent" class="col-sm-2 col-form-label">Handling
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" name="hagent"
                                                        value="@foreach ($k->history as $history)@if ($loop->first){{ old("hagent") ? old("hagent") : $history->hagent }}@else @endif @endforeach"
                                                        id="hagent">
                                        ...
                                        <div class="col-sm-12" style="margin-top: 10px">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label for="kep_loc" class="col-sm-2 col-form-label">Keeping
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" name="kep_loc"
                                                        value="@foreach ($k->history as $history)@if ($loop->first){{ old("kep_loc") ? old("kep_loc") : $history->kep_loc }}@else @endif @endforeach"
                                                        id="kep_loc">
                                        ...
                                        <div class="col-sm-12" style="margin-top: 10px">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="text" id="pricesell_idr" class="form-control"
                                                        name="pricesell_idr"
                                        ...
                                        <div class="col-sm-12" style="margin-top: 10px">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="text" id="pricesell_jpy" class="form-control"
                                                        name="pricesell_jpy"
                                        ...
                                        <div class="col-sm-12" style="margin-top: 10px">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label for="photo_highlight" class="col-sm-2 col-form-label">Photo

                                                    Highlight</label>

                                                <div class="col-sm-10">

                                                    <select class="form-control select2" name="photo_highlight"
                                                        id="photo_highlight" style="width: 100%;">
                                                        ...
                                                        @foreach ($k->history as $history)
                                                            @foreach (explode("|", $history->link_photo) as $image)
                                                                @if ($image != null)
                                                                    <option value="{{ $image }}"
                                                                        {{ $image == $history->photo_highlight ? "selected" : "" }}>
                                                    ...
                                                    @foreach ($k->history as $history)
                                                        @if ($loop->first)
                                                            @foreach (explode("|", $history->link_photo) as $image)
                                                                @if ($image == null)
                                                                @else
                                                                    <img width="125" id="link_photo"
                                                                        src="{{ asset("img/koi/photo/" . $image) }}"
                                                                        class="img-thumbnailh">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.length > 0) {
                            ...
                            $('#size, #hagent, #kep_loc, #pricesell_idr, #pricesell_jpy, #photo_highlight_input, #link_photo, #link_video, #link_trophy, #name_trophy, #link_certificate, #name_certificate, #buyer_name, #death_date, #death_note, #id_history')
                                .val('');
