        ...
        <div class="sidebar" style="background: #2c7abe">
            ...
            <nav class="mt-2">
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item" style="border-bottom: 3px solid #0186fc; display:flex; height: 50px;">

                        <a href="{{ route("cmskoi") }}" class="nav-link">
                        ...
                        <a href="{{ route("cmskoigrid") }}" class="nav-link"
                            style="text-align: right; height: 50px; background: black;">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <a href="{{ route("cmskoigfilteraz") }}" type="button"
                                                class="btn btn-default btn-flat"><i
                                                    class="fas fa-sort-alpha-down"></i></a>
                                                                    ...
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <div class="dropdown-menu" role="menu">
                                                                            ...
                                                                            <form action="{{ route("cmsstatusupdate") }}"
                                                                                ...
                                                                                <button
                                                                                    class="dropdown-item">Available</button>
                                                                            ...
                                                                            <form action="{{ route("cmsstatusupdate") }}"
                                                                                ...
                                                                                <button
                                                                                    class="dropdown-item">Death</button>
                                                            ...
                                                            <div class="item_add"
                                                                ...
                                                                <span style="display: flex !important;">
                                                                    ...
                                                                    <a href="#bannerformmodal{{ $k->id_koi }}"
                                                                        ...
                                                                        data-target="#modal-danger{{ $k->id_koi }}"><i
                                                            ...
                                                            <div class="item_add"
                                                                ...
                                                                <span style="display: flex !important;">
                                                                    ...
                                                                    <a href="{{ route("cmskoidetail", $k->id_koi) }}"
                                                                        ...
                                                                        data-toggle="modal"
                                                                        data-target="#modalShowVideo{{ $k->id_koi }}"><i
                                                                    ...
                                                                    <a href="{{ route("cmskoidetail", $k->id_koi) }}"
                                                                        ...
                                                                        data-toggle="modal"
                                                                        data-target="#modalShowPhoto{{ $k->id_koi }}"><i
                                                                    ...
                                                                    <a href="{{ route("cmskoidetail", $k->id_koi) }}"
                                                                        ...
                                                                        data-target="#modalShowDocument{{ $k->id_koi }}"><i
                                                                ...
                                                                <div class="modal-dialog">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer justify-content-between">
                                                                            ...
                                                                            <a href="{{ route("cmskoigridDelete", $k->id_koi) }}"
                                                                                type="button"
        ...
        <nav aria-label="Contacts Page Navigation">
            <ul class="pagination justify-content-center m-0">
                ...
                @for ($i = 1; $i <= $koi->lastPage(); $i++)
                    <li class="page-item {{ ($koi->currentPage() == $i) ? 'active' : '' }}"><a class="page-link"
                            href="{{ $koi->url($i) }}">{{ $i }}</a></li>
                    @endfor
                    @endif
            </ul>
        </nav>
