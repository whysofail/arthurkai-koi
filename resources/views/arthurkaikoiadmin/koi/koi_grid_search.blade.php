                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3"
                                      ...
                                      @endforeach
                                            ...
                                            <h6 style="padding-left: 10px; padding-right: 10px; padding-top: 10px;"><a href="{{ route('cmskoidetail', $k->id_koi) }}"> {{ $k->koi_code }}</a></h4>
                                            ...
                                            <div class="item_add" style="padding-left: 10px; padding-right: 10px; padding-bottom: 25px; padding-top: 25px; display: inline-flex;">
                                                <span style="display: flex !important;">
                                                    ...
                                                    <a href="{{ route('cmskoidetail', $k->id_koi) }}"
                                                        ...
                                                        data-target="#modalShowDocument{{ $k->id_koi }}"><i class="fas fa-photo-video"></i></a>
                                                    <!-- modalShowDocument -->
                                                    <div class="modal fade bannerformmodal{{ $k->id_koi }}"
