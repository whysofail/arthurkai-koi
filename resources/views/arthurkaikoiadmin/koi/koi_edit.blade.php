                        ...
                        <div class="content tab" id="contentDataKOI">
                            <section id="section-1" class="content-current">
                               ...
                               if (isset($k->history) && is_object($k->history)) {
                                ...
                                <div class="col-sm-12" style="margin-top: 10px">
                                    <div class="form-group row">
                                        <label for="koi_sequence" class="col-sm-2 col-form-label">Koi Sequence</label>
                                        <div class="col-sm-10">
                                            <!-- <input type="hidden" name="koi_sequence"  value="{{ $k->history[$totalHistory-1]->koi_sequence }}"> -->
                                            <input type="text" class="form-control" name="koi_sequence" id="koi_sequence"
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                data.forEach(function(item) {
                    ...
                    $('#size, #hagent, #kep_loc, #pricesell_idr, #pricesell_jpy, #photo_highlight_input, #link_photo, #link_video, #link_trophy, #name_trophy, #link_certificate, #name_certificate, #buyer_name, #death_date, #death_note, #id_history, #koi_sequence').val('');
