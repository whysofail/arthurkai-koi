    ...
    <section class="content pt-1">
        <div class="">
            <div class="card-body">
             ...
             <div class="row">
                <div class="col-sm-6">
                    <a href="{{ route('cmskoi') }}" class="btn btn-sm" style="margin-bottom: 5px; border-radius: 20px 1px 10px; border: black solid 1px; ">
                        <i class="fas fa-arrow-circle-left" style="position: relative; right: 3%; top: 1px;"></i>
                        back
                    </a>
                </div>
                <div class="col-sm-6" style="text-align: right">
                    <button type="button" class="btn btn-default dropdown-toggle dropdown-icon" data-toggle="dropdown" style="background: black; color: white;">
                        2024 <span class="sr-only">Toggle Dropdown</span>
                    </button>
              ...
              <div class="row">
                    ...
                    <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper mySwiper2">
                        <div class="swiper-wrapper">
                          ...
                          <div class="swiper-slide">
                            <img src="{{ asset('img/koi/photo/'. $image) }}" />
                          </div>
                          @endforeach
                          @endforeach
                        </div>
                ...
                <div class="col-12 col-lg-8 col-md-8 col-sm-8">
                    <div class="px-3" style="background: ">
                        <h2 class="mb-0" style="font-size: 2.2857142857142858rem; font-weight: 800; font-family: 'Open Sauce One', sans-serif;">
                            @foreach($koi as $k)
                            {{ $k->nickname }}
                            @endforeach
                        </h2>
                        <br>
                        <h2 class="mb-0" style="font-size: 1.2857142857142858rem; font-weight: 800; font-family: 'Open Sauce One', sans-serif;">
                            Variety : @foreach($koi as $k) {{ $k->variety }} @endforeach
                        </h2>
                        <br/><br/>
                        <div class="row mt-4">
                            <nav class="w-100">
                              <div class="nav nav-tabs" id="product-tab" role="tablist">
                                ...
                                <a class="nav-item nav-link" id="product-comments-tab" data-toggle="tab" href="#product-comments" role="tab" aria-controls="product-comments" aria-selected="false">Detail Information</a>
                                <a class="nav-item nav-link" id="trophy-tab" data-toggle="tab" href="#trophy" role="tab" aria-controls="trophy" aria-selected="false">Certification and Trophy</a>
                              </div>
                            </nav>
                            <div class="tab-content p-3" id="nav-tabContent">
                              <div class="tab-pane fade active show" id="product-desc" role="tabpanel" aria-labelledby="product-desc-tab">Lorem ipsum dolor sit amet consectetur adipisicing elit. At quae inventore reiciendis voluptate vero distinctio voluptatum temporibus velit iste, magni laboriosam ut fugit? Iure atque aperiam quia cumque sit reiciendis.<br> Lorem ipsum dolor sitcum minus quis sapiente odio mollitia!, Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quos impedit ex vero similique, culpa perferendis nisi vitae ipsam, accusamus veniam sequi quidem reiciendis animi beatae numquam. Atque, rerum amet? Praesentium. <br><br> Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt maxime inventore quis ipsa ullam praesentium blanditiis sint numquam veniam aliquid eius or, perspiciatis eum odio quo.<br/><br/> <video playsinline autoplay muted loop width="400"><source src="{{ asset('img/koi/video/'. $k->link_video) }}" type="video/mp4"/></video></div>
                              <div class="tab-pane fade" id="product-comments" role="tabpanel" aria-labelledby="product-comments-tab">
                                <P>
                                    ...
                                    <b>Date Of Ownership : {{ $k->date_purchese }}</b><br>
                                    <b>Birthday Year & Month : {{ $k->birth }}</b><br>
                                    @endforeach
                                </P>
                              </div>
                              <div class="tab-pane fade" id="trophy" role="tabpanel" aria-labelledby="trophy-tab">
                                <div class="row" style="text-align: center">
                                    <div class="col-sm-4">
                                        <img style="width: 100%"  width="150" class="img-thumbnail" src="{{ asset('img/koi/certificate/'. $k->link_certificate) }}"><br><br>
                                        <p>{{ $k->name_trophy }}</p>
                                    </div>

                                    <div class="col-sm-4">
                                        <img style="width: 100%" class="img-thumbnail" src="{{ asset('img/koi/trophy/'. $k->link_trophy) }}"><br><br>
