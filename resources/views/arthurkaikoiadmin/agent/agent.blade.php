                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span style="display: flex !important">
                                                    <a href="{{ route('cmsagentEdit', $a->id_agent) }}" type="button"
                                                        class="btn btn-info btn-xs">Edit</a> |
                                                    <a href="{{ route('cmsagentDelete', $a->id_agent) }}" type="button"
                                                        class="btn btn-danger btn-xs">Delete</a> |
                                                </span>
                                            </td>
                                            <td>{{ $a->agent_name }}</td>
                                            <td>{{ $a->agent_location }}</td>
                                            <td>{{ $a->agent_website }}</td>
                                            <td>{{ $a->agent_owner }}</td>
                                            <td>{{ $a->agent_code }}</td>
                                        </tr>
                                        <?php $no++; ?>
