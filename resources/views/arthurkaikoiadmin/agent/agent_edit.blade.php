                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="name"
                                                        value="{{ old("name") ? old("name") : $a->name }}" id="name">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12" style="margin-top: 10px">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="location"
                                                        value="{{ old("location") ? old("location") : $a->location }}"
                                                        id="location">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" name="website"
                                                        value="{{ old("website") ? old("website") : $a->website }}"
                                                        id="website">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" name="owner"
                                                        value="{{ old("owner") ? old("owner") : $a->owner }}"
                                                        id="owner">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" name="code"
                                                        value="{{ old("code") ? old("code") : $a->code }}" id="code">
