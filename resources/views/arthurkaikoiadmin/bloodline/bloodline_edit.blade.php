...
<div class="content-wrapper" style="background: white;">
    ...
    <section class="content">
        ...
        <form action="{{ route('cmsbloodlineUpdate') }}" method="POST" enctype="multipart/form-data">
            @csrf
                            ...
                            <section id="section-1" class="content-current">
                                ...
                                <div class="col-sm-12" style="margin-top: 10px">
                                    <div class="form-group row">
                                        <label for="bloodline_name" class="col-sm-2 col-form-label">Bloodline Name</label>
                                        <div class="col-sm-10">
                                ...
                                <div class="col-sm-12" style="margin-top: 10px">
                                    <div class="form-group row">
                                        <label for="bloodline_code" class="col-sm-2 col-form-label">Bloodline Code</label>
                                        <div class="col-sm-10">
