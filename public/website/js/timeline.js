jQuery(document).ready(function($) {
    ...
    function updateVisibleContent(event, eventsContent) {
        ...
        // Update the image based on the selected event
        var selectedImage = event.data('image');
        $('#image-container').attr('src', selectedImage);
    }
    ...
    // Based on the resolution of the timeline, there are different ways to handle event dates
...
// 	var newImageSrc = getImageSrcForEvent(eventDate); // Function to get the new image src
//     $('#timeline-image').attr('src', newImageSrc);
// }

// var locallink ="https://staging.arthurkai-koi.com/";

// function getImageSrcForEvent(eventDate) {
//     switch(eventDate) {
//         case '01/01/2020':
//             return locallink + 'website/images/koi.png';
//         case '01/01/2021':
//             return locallink + 'website/images/Tancho_Show.jpg';
//         case '01/01/2022':
//             return locallink + 'website/images/Tancho_Show.jpg';
//         case '01/01/2023':
//             return locallink + 'website/images/Tancho_Show.jpg';
...
//             return locallink + 'website/images/Tancho_Show.jpg';
//         default:
//             return locallink + 'website/images/default.png';
//     }
// }
